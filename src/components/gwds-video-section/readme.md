...
| `videoPoster`        | `video-poster`         |             | `string`                                 | `null`      |
...
- [gwds-video-lite](../gwds-video-lite)
...
graph TD;
  ...
  gwds-video-section --> gwds-video-lite
  gwds-video-section --> gwds-video
  style gwds-video-section fill:#f9f,stroke:#333,stroke-width:4px
```
